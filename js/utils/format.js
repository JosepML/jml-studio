...
// Mismas claves que ESTADOS_FACTURA (mismo campo `estado` en la tabla, para no
// migrar datos), pero con las etiquetas que tienen sentido para un
// presupuesto en vez de una factura.
export const ESTADOS_PRESUPUESTO = {
  borrador: { label: "Borrador",  bg: "#F0F1F4", fg: "#5B6478" },
  emitida:  { label: "Enviado",   bg: "#FFF3D6", fg: "#8A6A10" },
  pagada:   { label: "Aceptado",  bg: "#E3F1EA", fg: "#2E7D53" },
  vencida:  { label: "Rechazado", bg: "#FDEBD8", fg: "#B4571C" },
};
